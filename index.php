...
<body class="template-color-1 spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="70">
    ...
    <main class="main-page-wrapper">
                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                        <div class="order-2 order-lg-1 col-lg-7 mt_md--50 mt_sm--50 mt_lg--30">
                            <div class="content">
                                <div class="inner">
                                    ...
                                    <h1 class="title">Hi, I’m <span>Suhail Akhtar</span><br>
                                    ...
                                    <div>
                                        <p class="description">Hello! my name is Suhail Akhtar, I am a highly skilled
                                            Full
                                            Stack Developer with a passion for building dynamic and high-performing web
                                            applications. With strong proficiency in PHP and the Laravel Codeigniter framework, I
                                            specialize in delivering effective solutions for complex challenges while
                                            maintaining clean, optimized code.
                                           <br>
                                            I enjoy the constant change in the technologies used in the area and love
                                            diving into new frameworks and technologies.
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12">
                                        <div class="social-share-inner-left">
                                            ...
                                            <ul class="social-share d-flex liststyle">
                                                ...
                                                <li class="linkedin"><a href="https://www.linkedin.com/in/suhail--akhtar/"><i data-feather="linkedin"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                        <div class="skill-share-inner">
                                            ...
                                            <ul class="skill-share d-flex liststyle">
                                                <li><img src="assets/images/icons-01 (1).png" alt="Icons Images"></li>
                                                <li><img src="assets/images/icons-02.png" alt="Icons Images"></li>
                                                <li><img src="assets/images/icons-03.png" alt="Icons Images"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                     <img src="assets/images/suhail_bg.png" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">Full-Stack Development: Develop end-to-end solutions,
                                        managing both front-end and back-end components. E-commerce Solutions: Develop
                                        robust e-commerce platforms with features like product catalogs, payment
                                        gateways, and order tracking. Create or customize Content Management Systems
                                        (CMS) or custom Laravel-based CMS.</p>
                                    <a class="read-more-button" href=""><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true"
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Third-Party Integrations
                                        </a></h4>
                                    <p class="description">Payment Gateway Integration: Set up and configure gateways
                                        like Razorpay, PayPal, or Stripe. API Integrations: Connect with external
                                        services (e.g., social media, email APIs, or analytics tools). Email Services:
                                        Implement email notifications and newsletters using services like Mailgun or
                                        SendGrid.</p>
                                    <a class="read-more-button" href="#"><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true"
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Authentication & Security
                                        </a></h4>
                                    <p class="description">User Authentication Systems: Implement secure login and
                                        registration systems, including features like OTP-based verification and social
                                        logins. Data Encryption & Security Audits: Ensure data safety by encrypting
                                        sensitive information and performing security checks.</p>
                                    <a class="read-more-button" href="#"><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Optimization & Maintenance
                                        </a></h4>
                                    <p class="description">Performance Optimization: Enhance website speed using
                                        caching, query optimization, and code refactoring. Ongoing Maintenance &
                                        Support: Provide long-term support, bug fixing, and feature enhancements.
                                    </p>
                                    <a class="read-more-button" href="#"><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" data-aos-once="true"
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Database & Backend Services
                                        </a></h4>
                                    <p class="description">Database Design & Management: Create efficient MySQL or
                                        PostgreSQL schemas and manage migrations. Data Migration Services: Migrate data
                                        from legacy systems or other platforms into Laravel applications.</p>
                                    <a class="read-more-button" href="#"><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" data-aos-once="true"
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Front-End Integration
                                        </a></h4>
                                    <p class="description"> Responsive UI Design: Create mobile-friendly, responsive
                                        interfaces using HTML, CSS (Bootstrap or Tailwind), and JavaScript. Template
                                        Customization: Integrate and customize templates or themes in Laravel Blade.</p>
                                    <a class="read-more-button" href="#"><i data-feather="arrow-right"></i></a>
                                </div>
                            </div>
                            <a class="over-link" href="#"></a>
            ...
            <div class="container">
                ...
                <div class="row row--25 mt--10 mt_md--10 mt_sm--10">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-5">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/screenshot-3.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                        ...
                                        <div class="meta">
                                            <span><a href="javascript:void(0)"><i data-feather="thumbs-up" style="width: 20px; height: 20px; padding-bottom: 5%;" ></i></a>
                                                600</span>
                                        </div>
                                    </div>
                                    <h4 class="title"><a href="javascript:void(0)">Grow Mark a Modern Real Estate
                                            Solution </a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
                        class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-6">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/screenshoot-4.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)">E-shoper Online Shopping Platform
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
                        ...
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-6">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/Screenshot-5.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)">Personal Financial Budget Analysis
                                           </a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true"
                        class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-2">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/screenshot-1.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)">Hotel & Resort Website landing design
                                            &
                                            Services</a></h4>
                                </div>
                            </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
                        class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-3">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/screenshoot.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)">Dentist Website Landing Design
                                            </a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
                        class="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter-4">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/screenshot-2.png" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                                    ...
                                    <h4 class="title"><a href="javascript:void(0)"> Tour & Travel Website Landing Design
                                            & Services
                                            </a></h4>
                                </div>
                            </div>
                        ...
                        <ul class="rn-nav-list nav nav-tabs" id="myTabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="experience-tab" data-bs-toggle="tab" href="#experience"
                                    role="tab" aria-controls="experience" aria-selected="false">Certifications</a>
                            </li>
                            <!-- <li class="nav-item">
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4> Bachelor's of Computer Application (BCA)</h4>
                                                                    <span>J.S University Shikohabad (2020 - 2023)</span>
                                                                </div>
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Class 12th</h4>
                                                                    <span>Central Board Of Secondary Education -
                                                                        CBSE(2020)</span>
                                                                </div>
                                            ...
                                            <div class="progress-wrapper">
                                                <div class="content">
                                                    ...
                                                    <!-- End Single Progress Charts -->
                                                          ...
                                                          <!-- Start Single Progress Charts -->
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">Sketch</h6>
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft"
                                                                data-wow-duration="0.9s" data-wow-delay=".7s"
                                                                role="progressbar" style="width: 70%" aria-valuenow="85"
                                                    ...
                                                    <!-- End Single Progress Charts -->
                                                               ...
                                                               <!-- Start Single Progress Charts -->
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">InVision</h6>
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft"
                                                                data-wow-duration="0.9s" data-wow-delay=".7s"
                                                                role="progressbar" style="width: 60%" aria-valuenow="85"
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="progress-charts">
                                                        ...
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft"
                                                                data-wow-duration="0.8s" data-wow-delay=".6s"
                                                                role="progressbar" style="width: 82%" aria-valuenow="85"
                                                                aria-valuemin="0" aria-valuemax="100"><span
                                                                    class="percent-label">82%</span></div>
                                                        </div>
                                                    </div>
                                                    <!-- End Single Progress Charts -->
                                                ...
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>PHP Full Stack Certification</h4>
                                                                    <span>DUCAT</span>
                                                                </div>
                                                            </div>
            ...
            <div class="container">
                ...
                <div class="row row--25 mt--30 mt_md--10 mt_sm--10">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog-01.jpg" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="150" data-aos-once="true"
                        class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters2">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog-02.jpg" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="200" data-aos-once="true"
                        class="col-lg-6 col-xl-4 mt--30 col-md-6 col-sm-12 col-12 mt--30">
                        <div class="rn-blog" data-bs-toggle="modal" data-bs-target="#exampleModalCenters3">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="assets/images/blog-03.jpg" alt="Personal Portfolio Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="category-info">
                    ...
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            ...
                            <div class="description">
                                ...
                                <span class="phone">Phone: <a href="tel:01941043264">+91 8750083134</a></span>
                                <span class="mail">Email: <a
                                        href="mailto:admin@example.com">suhailakhtar689@gmail.com</a></span>
                            </div>
                            <div class="social-area">
                                <div class="name">FIND WITH ME</div>
                                <div class="social-icone">
                                    <a href="https://github.com/suhailakhtar689/"><i data-feather="github"></i></a>
                                    <a href="https://www.linkedin.com/in/suhail--akhtar/"><i
                    ...
                    <div data-aos-delay="600" class="col-lg-7 contact-input">
                        <div class="contact-form-wrapper">
                            <div class="introduce">
                                ...
                                <form class="rnt-contact-form rwt-dynamic-form row" method="POST" action="mail.php">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="portfolio-popup-thumbnail">
                                    <div class="image">
                                        <img class="w-100" src="assets/images/screenshot-3.png" alt="slide">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="text-content">
                                    <h3>
                                        <span>Featured - Development</span> Grow Mark a Modern Real Estate Solution
                                    </h3>
                                    <p class="mb--30">Developed a dynamic and feature-rich real estate landing page,
                                        titled "Grow Mark," designed to showcase property listings and services. The
                                        layout emphasizes modern design, user-friendly navigation, and robust
                                        functionality, catering to both buyers and sellers in the real estate market.
                                        Responsive Design: Optimized for seamless performance across desktops, tablets,
                                        and mobile devices.
                                        User Authentication: Secure login system for property agents and clients.
                                    </p>
                    ...
                    <div class="modal-body">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="portfolio-popup-thumbnail">
                                    <div class="image">
                                        <img class="w-100" src="assets/images/Screenshot-1.png" alt="slide">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="text-content">
                                    <h3>
                                        <span>Featured - Design</span> Hotel & Resort Website landing Design & Service
                                    </h3>
                                    <p class="mb--30">Designed and developed an elegant and user-friendly landing page
                                        for a Hotel & Resort website, focusing on delivering a seamless user experience
                                        and showcasing the resort’s luxurious services.
                                        Responsive Design: Ensured a flawless experience across all devices (desktop,
                                        tablet, mobile).
                                        Dynamic Services Section: Highlighted key offerings such as room categories, spa
                                        services, dining options, and booking facilities.
                                    </p>
                                    <div class="button-group mt--20">
                                        <!-- <a href="#" class="rn-btn thumbs-icon">
                                            <span>LIKE THIS</span>
                    ...
                    <div class="modal-body">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="portfolio-popup-thumbnail">
                                    <div class="image">
                                        <img class="w-100" src="assets/images/Screenshoot.png" alt="slide">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="text-content">
                                    <h3>
                                        <span>Featured - Design</span> Dentist Website Landing Design
                                    </h3>
                                    <p class="mb--30">Designed a modern, responsive, and user-friendly landing page
                                        tailored for dental clinics. The layout emphasizes trust, professionalism, and a
                                        welcoming environment to attract new patients and provide existing ones with a
                                        seamless browsing experience.Responsive Design: Optimized for all devices,
                                        ensuring a smooth experience on desktop, tablet, and mobile.
                                    </p>
                                    <div class="button-group mt--20">
                                        <!-- <a href="#" class="rn-btn thumbs-icon">
                                            <span>LIKE THIS</span>
                    ...
                    <div class="modal-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="text-content">
                                    <h3>
                                        <span>Featured - Design</span> Tour & Travel Website Landing Design & Service
                                    </h3>
                                    <p class="mb--30">Designed an engaging, user-centric landing page for a tour and
                                        travel agency, focusing on inspiring wanderlust and facilitating seamless trip
                                        planning. The design combines aesthetic appeal with functional elements to
                                        attract travelers and convert visitors into customers.Responsive Design:
                                        Optimized for seamless performance across desktops, tablets, and mobile devices.
                                    </p>
                                    <div class="button-group mt--20">
                                        <!-- <a href="#" class="rn-btn thumbs-icon">
                                            <span>LIKE THIS</span>
                    ...
                    <div class="modal-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="text-content">
                                    <h3>
                                        <span>Featured - Development</span>Personal Financial Budget Analysis
                                    </h3>
                                    <p class="mb--30">The Personal Financial Budget Analysis project focuses on creating
                                        a comprehensive tool that helps individuals track their income, expenses, and
                                        savings goals Income & Expense Tracking: Allows users to log and categorize
                                        their income and expenses.
                                        Budget Planning: Users can set monthly or annual budgets and track progress
                                        against those goals.
                                        Spending Analysis: Provides detailed reports and graphs to analyze spending
                                        habits across different categories (e.g., groceries, utilities, entertainment).
                                    </p>
                                    <div class="button-group mt--20">
                                        <!-- <a href="#" class="rn-btn thumbs-icon">
                                            <span>LIKE THIS</span>
        ...
        <div class="modal fade" id="exampleModalCenters1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-news" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="assets/images/blog-01.jpg" alt="news modal" class="img-fluid modal-feat-img" style="width: 50%; height: 80%">
                        <div class="news-details">
                            <!-- <span class="date">2 May, 2021</span> -->
                            <h2 class="title">T-shirt design is the part of design </h2>
                            <p style="text-align: justify;">1. Project Overview:

Describe the purpose of the T-shirt designs (e.g., personal project, client work, or for a brand).
Explain the design process (from concept to final product).
<br>
2. Visual Showcase:
Include high-quality images of your T-shirt designs.
Show mockups (using tools like Photoshop or online mockup generators).
Technical Aspects:
<br>
3. Mention the tools used (e.g., Adobe Illustrator, Photoshop, or Figma).
Discuss any web technologies involved if you created a T-shirt design preview tool.
<br>
4. Development Integration:
If you've built a T-shirt customization web app, explain how users can interact with it.
Share code snippets or challenges faced during development.
User Experience Focus:

Discuss how you ensured a good user experience (UX) in presenting the designs online.
</p>
                        </div>
        ...
        <div class="modal fade" id="exampleModalCenters2" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-news" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="assets/images/blog-02.jpg" alt="news modal" class="img-fluid modal-feat-img" style="width: 50%; height: 80%">
                        <div class="news-details">
                            <!-- <span class="date">2 May, 2021</span> -->
                            <h2 class="title">The services provide for design  </h2>
                            <p style="text-align: justify;">1. Development Services: This section lists your skills related to coding, web development, and technical solutions like backend technologies, API integrations, and database management. <br>
                                                            2. Design Services: Highlight your design skills, such as UI/UX design, responsive design, and branding (e.g., T-shirt designs). <br>
                                                            3. Tone: The tone is professional yet approachable, emphasizing your versatility in both development and design.</p>
                        </div>
        ...
        <div class="modal fade" id="exampleModalCenters3" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-news" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="assets/images/blog-03.jpg" alt="news modal" class="img-fluid modal-feat-img" style="width: 50%; height: 80%">
                        <div class="news-details">
                            <!-- <span class="date">2 May, 2021</span> -->
                            <h2 class="title">Mobile app landing design & app maintain </h2>
                            <p style="text-align: justify;">1. Responsive Design: Ensures the landing page works across all devices. <br>
2. Regular Updates & Performance Monitoring: Keeps the app up-to-date and high-performing. <br>
3. User Feedback Integration & Security Enhancements: Incorporates feedback from users and adds security updates. <br>
4. Compatibility Checks: Ensures the app works on newer devices and OS versions.</p>
                        </div>
